        ...
        <div className=" flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-72">
          <CardContainer className=" inter-var">
            <CardBody className=" bg-gray-50 relative group/card dark:hover:shadow-xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border">
              ...
              <CardItem
                translateZ="60"
                className=" text-sm max-w-sm font-bold text-neutral-500 dark:text-neutral-300 mt-2"
              >
                 Get a glimps of what our software is capable of. Just a heads up {"you'll"} never leave us after this!
          ...
          <CardContainer className=" inter-var">
            <CardBody className=" bg-gray-50 relative group/card dark:hover:shadow-xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black dark:border-[#E2CBFF] border-black/[0.1] w-full md:!w-[350px] h-auto rounded-xl p-6 border">
              <CardItem
                translateZ="50"
                className=" text-xl font-bold text-neutral-600 dark:text-white"
              >
                Pro Plan
                <h1 className="text-6xl">$27</h1>
              </CardItem>
              <CardItem
                translateZ="60"
                className=" text-sm max-w-sm font-bold text-neutral-500 dark:text-neutral-300 mt-2"
