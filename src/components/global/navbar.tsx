...
const Navbar =  async (props: Props) => {
  return (
    <header className='fixed left-0 right-0 top-0 px-4 py-4 bg-white/40 backdrop-blur-lg z-[100] flex items-center border-b-[1px] border-neutral-900 justify-between'>
